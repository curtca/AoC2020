...
namespace test
{
    public class UnitTest1
    {
        ...
        public static IEnumerable<object[]> Data =>
            new List<object[]>
            {
                new object[] { sample1, 46 },
                new object[] { sample2, 1445 },
                new object[] { sample3, 669060 },
                new object[] { sample4, 23340 },
                new object[] { input, 43423343619505 },
            };

        static string sample1 = "2 * 3 + (4 * 5)";
        static string sample2 = "5 + (8 * 3 + 9 + 3 * 4 * 3)";
        static string sample3 = "5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))";
        static string sample4 = "((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2";
