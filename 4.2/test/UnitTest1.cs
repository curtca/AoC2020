...
namespace test
{
    public class UnitTest1
    {
        ...
        {
            lib.Passports p = new lib.Passports();
            var countValid = p.CountValid(input);
            Assert.Equal(expected, countValid);
        }

        public static IEnumerable<object[]> Data =>
            new List<object[]>
            {
                new object[] { invalid4, 0},
                new object[] { valid4, 4},
                new object[] { input, 156 },
            };

        static string invalid4 =
@"eyr:1972 cid:100
