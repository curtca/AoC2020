...
namespace test
{
    public class UnitTest1
    {
        ...
        public void Reports_AddTo2020_Product(string input, int countValidExpected)
        {
            lib.Passwords pw = new lib.Passwords();
            var countValid = pw.CountValid(input);
            Assert.Equal(countValid, countValidExpected);
        }
